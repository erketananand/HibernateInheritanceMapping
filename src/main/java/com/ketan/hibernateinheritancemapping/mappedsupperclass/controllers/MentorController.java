...
import com.ketan.hibernateinheritancemapping.mappedsupperclass.services.MentorService;
import org.springframework.web.bind.annotation.*;

import java.util.List;

@RestController("msMentorController")
@RequestMapping("/mappedSupperClass/mentor")
