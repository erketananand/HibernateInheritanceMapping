...
import com.ketan.hibernateinheritancemapping.tableperclass.services.StudentService;
import org.springframework.web.bind.annotation.*;

import java.util.List;

@RestController("tpcStudentController")
@RequestMapping("/tablePerClass/student")
